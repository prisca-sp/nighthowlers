...
def load_health_records():
    return r"C:\Users\Kireeti\OneDrive\Desktop\healthcare_dataset.csv"
...
async def fetch_smartphone_data():
    ...
    if not target_device:
        print("❌ 'kireeti' not found. Ensure Bluetooth is enabled.")
        return None
...
async def run_health_analysis():
    ...
    print("⏳ Connecting to kireeti...")
    real_time_data = await fetch_smartphone_data()
    if not real_time_data:
        print("❌ Unable to fetch data from kireeti.")
        return
